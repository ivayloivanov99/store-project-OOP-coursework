...
public class CreditCardWrite {

	private static final String ITEMS_FILE_EXTENSION = ".file";
	private static final String ITEMS_FILE_NAME = "creditcardorders";
	...
	public static ArrayList<CreditCardModel> itemList = new ArrayList<>();
	...
	public static void writeItems(CreditCardModel item) {
		...
		try {
			...
			writer.append(item.getCardNumber() + "\t");
